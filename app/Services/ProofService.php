...
class ProofService
{
    ...
    public function updateCuration(int $proofId, bool $showPublic): array
    {
        ...
        if ($showPublic) {
            ...
            if (!$exists) {
                $displayData = \App\Services\CurationService::resolveDisplayData('activity', $proofId);
                db_insert('curated_media', [
                    ...
                    'thumbnail_attempted' => $thumbnailUrl ? 1 : 0,
                    'user_id'        => $displayData['user_id'],
                    'display_name'   => $displayData['display_name'],
                    'display_avatar' => $displayData['display_avatar'],
