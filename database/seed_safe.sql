-- ============================================================================
-- DesbravaHub - Safe Seed Data (Idempotent)
-- Use this script if you get "Duplicate entry" errors with the normal seed.
-- ============================================================================
...
INSERT IGNORE INTO `levels` (`level_number`, `name`, `min_xp`) VALUES
(1, 'Iniciante', 0),
(2, 'Explorador', 100),
(3, 'Aventureiro', 300),
(4, 'Desbravador', 600),
...
INSERT IGNORE INTO `app_versions` (`version_code`, `version_number`, `release_notes`, `is_active`, `released_at`) VALUES
...
INSERT IGNORE INTO `feature_flags` (`key`, `name`, `description`, `default_enabled`) VALUES
...
INSERT IGNORE INTO `tenants` (`slug`, `name`, `description`, `status`, `settings`) VALUES
...
-- Get the tenant ID (robust lookup)
SET @tenant_id = (SELECT id FROM tenants WHERE slug = 'demo-club');

-- ============================================================================
-- DEMO ROLES (for demo tenant)
-- ============================================================================

INSERT IGNORE INTO `roles` (`tenant_id`, `name`, `display_name`, `description`, `is_system`) VALUES
...
INSERT IGNORE INTO `users` (`tenant_id`, `role_id`, `email`, `password_hash`, `name`, `xp_points`, `level_id`, `status`) VALUES
...
INSERT IGNORE INTO `activities` (`tenant_id`, `title`, `description`, `min_level`, `xp_reward`, `is_outdoor`, `proof_types`, `status`, `order_position`, `created_by`) VALUES
...
INSERT IGNORE INTO `activity_prerequisites` (`activity_id`, `prerequisite_activity_id`) VALUES
...
INSERT IGNORE INTO `achievements` (`tenant_id`, `name`, `description`, `xp_reward`, `criteria_type`, `criteria_value`) VALUES
