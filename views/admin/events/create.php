                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control">
                            <option value="regular">Regular / Geral</option>
                            <option value="mission">Missão Operacional</option>
                            <option value="camp">Acampamento / Bivaque</option>
                            <option value="training">Treinamento / Classe</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="achievement_id" class="form-control">
                            ...
                            <?php foreach ($achievements as $achievement): ?>
                                <option value="<?= $achievement['id'] ?>"><?= htmlspecialchars($achievement['name']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>URL Imagem de Capa</label>
                        <input type="url" name="cover_image_url" class="form-control" placeholder="https://exemplo.com/banner.jpg">
                    </div>
                </div>
            </div>
