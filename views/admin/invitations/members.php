<?php
/**
 * Member Invitations - Master Design v2.0
...
">
    ...
    <div class="header-actions">
        <a href="<?= base_url($tenant['slug'] . '/admin/convites/membros/novo') ?>" class="btn btn-primary">
...
<div class="invites-wrapper">
    ...
    <?php if (empty($pending)): ?>
        <div class="dashboard-card" style="text-align: center; padding: 4rem 2rem; align-items: center;">
            ...
            <p style="color: var(--text-muted);">Convide novos membros para fortalecer seu clube</p>
        </div>
    <?php else: ?>
                        ...
                        <div style="display: flex; gap: 1rem; align-items: center;">
                            ...
                            <div style="min-width: 0;">
                                ...
                                <div style="font-size: 0.8rem; color: var(--text-muted);">
                                    <?= htmlspecialchars($invite['name'] ?? 'Futuro Membro') ?>
                                </div>
                            </div>
                        </div>
    ...
    <?php if (!empty($accepted)): ?>
        <div style="margin: 2rem 0 1.5rem; display: flex; align-items: center; gap: 0.75rem;">
            ...
            <h3 style="margin: 0; font-size: 1.125rem; font-weight: 700; color: var(--text-dark);">Membros Integrados</h3>
                                ...
                                <td data-label="Membro">
                                    <div style="display: flex; align-items: center; gap: 1rem;">
                                        ...
                                        <div>
                                            ...
                                            <div style="font-size: 0.8rem; color: var(--text-muted);"><?= htmlspecialchars($invite['name'] ?? 'Novo Desbravador') ?></div>
                                        </div>
                                    </div>
                                </td>
