<?php
/**
 * Gestão de Convites (Membros) - Elegance & Precision v1.0
 * Um design refinado para gerenciar a entrada de novos desbravadores.
 */
?>
...
<div class="inv-container">
    ...
    <header class="inv-header-sticky">
        <nav class="inv-tabs">
            ...
            <a href="<?= base_url($tenant['slug'] . '/admin/convites/membros') ?>" class="inv-tab-link active">
        ...
        <a href="<?= base_url($tenant['slug'] . '/admin/convites/membros/novo') ?>" class="btn-inv-primary">
    ...
    <div class="inv-content-wrapper">
        ...
        <?php if (empty($pending)): ?>
            <div class="inv-registry-card" style="padding: 80px 40px; text-align: center;">
                ...
                <h4 style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 700; color: var(--inv-text-main);">Nenhum Convite Ativo</h4>
                <p style="color: var(--inv-text-muted); max-width: 320px; margin: 8px auto 24px auto;">Não há desbravadores aguardando integração no momento.</p>
                <a href="<?= base_url($tenant['slug'] . '/admin/convites/membros/novo') ?>" class="btn-inv-primary" style="display: inline-flex;">Convidar Agora</a>
            </div>
        <?php else: ?>
                ...
                <?php foreach ($pending as $invite): ?>
                    <div class="inv-envelope-card">
                        <div class="inv-card-header">
                            <span style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; font-size: 0.75rem; color: #fbbf24;">DH-MBR-<?= str_pad($invite['id'], 3, '0', STR_PAD_LEFT) ?></span>
                        ...
                        <div class="inv-user-profile">
                            ...
                            <div class="inv-user-info">
                                ...
                                <span><?= htmlspecialchars($invite['name'] ?? 'Futuro Desbravador') ?></span>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; align-items: center; gap: 8px; font-weight: 600; color: var(--inv-text-main); font-size: 0.9rem;">
                                        <span class="material-icons-round" style="font-size: 18px; color: var(--inv-accent);">badge</span>
