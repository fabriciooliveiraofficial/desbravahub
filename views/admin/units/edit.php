...
<style>
    ...
    .chip-remove {
        /* Shared partial will handle icon picker styles */
    }
    .chip-remove:hover {
        background: #ef4444;
        color: white;
    ...
    /* Cleaned up local icon picker styles */
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <button type="button" class="icon-picker-trigger" 
                                    onclick="IconPicker.open(document.getElementById('mascotInput').value, (sel) => {
                                        document.getElementById('mascotInput').value = sel;
                                        document.getElementById('iconPreview').innerHTML = `<iconify-icon icon='${sel}' style='font-size: 1.5rem;'></iconify-icon>`;
                                        document.getElementById('iconText').textContent = sel;
                                    })">
                                <div class="icon-picker-preview" id="iconPreview">
                                     <?php 
                                         $currentIcon = empty($unit['mascot']) ? 'lucide:star' : $unit['mascot'];
...
<script>
    ...
    /* Legacy icon picker logic removed, handled by shared component */
</script>
